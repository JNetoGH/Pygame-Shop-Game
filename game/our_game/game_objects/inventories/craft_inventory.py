...
class CraftablesInventory(GameObject):
    ...
    def __init__(self, name: str, scene, rendering_layer):
        ...
        self.copper_sword_recept = CraftableRecipe("copper sword", 20, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.iron_sword_recept = CraftableRecipe("iron sword", 30, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.bow_recept = CraftableRecipe("bow", 5, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.ouro_sword_recept = CraftableRecipe("ouro sword", 20, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.diamond_sword_recept = CraftableRecipe("diamond sword", 30, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.rubi_sword_recept = CraftableRecipe("rubi sword", 40, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.iron_hammer_recept = CraftableRecipe("iron hammer", 10, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.iron_chest_recept = CraftableRecipe("iron chest", 20, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.iron_helm_recept = CraftableRecipe("iron helm", 20, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.leather_legs_recept = CraftableRecipe("leather legs", 5, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.ouro_helm_recept = CraftableRecipe("ouro helm", 15, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.ouro_legs_recept = CraftableRecipe("ouro legs", 15, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.rubi_feet_recept = CraftableRecipe("rubi feet", 45, 10, required_items, output, self.scene, self.rendering_layer)
        ...
        self.bronze_feet_recept = CraftableRecipe("bronze feet", 10, 10, required_items, output, self.scene, self.rendering_layer)
